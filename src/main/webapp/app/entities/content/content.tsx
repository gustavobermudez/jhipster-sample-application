  ...
  return (
    <div>
      <h2 id="content-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.content.home.title">Contents</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.content.home.createLabel">Create new Content</Translate>
        </Link>
      </h2>
        ...
        {contentList && contentList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.content.home.notFound">No Contents found</Translate>
            </div>
          )
        )}
      </div>
