...
export const ContentDeleteDialog = (props: IContentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.content.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.content.delete.question" interpolate={{ id: contentEntity.id }}>
